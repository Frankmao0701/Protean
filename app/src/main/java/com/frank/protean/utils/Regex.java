package com.frank.protean.utils;

import com.frank.protean.activity.UrlPictureActivity;
...
public class Regex {
    ...
    public static String pregMatch(String content, String pattern, int index) {
        ...
        return UrlPictureActivity.extendedTrim(match);
    }
    ...
    public static List<String> pregMatchAll(String content, String pattern,
        ...
        while (matcher.find()) {
            matches.add(UrlPictureActivity.extendedTrim(matcher.group(index)));
        }
    ...
    public static List<String> pregMatchAllImages(String content, String pattern) {
        ...
        while (matcher.find()) {
            matches.add(UrlPictureActivity.extendedTrim(matcher.group(3))
                    + matcher.group(4));
        }
